<div class="lengow_default_carrier"
     ...
     id="lengow_country_{$defaultCarrierCountries[$id_country]['lengow_country_id']}">
    <h3>Default carrier</h3>
    <select name="default_carrier[{$defaultCarrierCountries[$id_country]['lengow_country_id']}]" class="carrier defaultCarrier lengow_select">
        <option value=""></option>
