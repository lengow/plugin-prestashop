            ...
            <div class="lengow_feed_block_header">
                ...
                <div class="lengow_feed_block_header_content">
                    ...
                    <div class="lengow_feed_block_content_left">
                        ...
                        <p>
                            <input id="link_shop_{$shop['shop']->id|escape:'htmlall':'UTF-8'}"
                                   value="{$shop['link']|escape:'htmlall':'UTF-8'}" readonly>
                        ...
                        {if $shop['last_export']}
                            ...
                            <br/>
                        {else}
                            {$locale->t('product.screen.no_export')|escape:'htmlall':'UTF-8'}
                            <br/>
                        {/if}
                    </div>
