    ...
    <div class="lgw-content-section text-center">
        <div id="lgw-footer">
            <p class="text-center">
                ...
                | {$locale->t('footer.plugin_lengow')|escape:'htmlall':'UTF-8'} - v.{$lengowVersion|escape:'htmlall':'UTF-8'} {if $lengowUrl === 'lengow.net'}<span class="lgw-label-preprod">sandbox</span>{/if}
