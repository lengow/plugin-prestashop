...
<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
    ...
    <div class="panel panel-default">
        <h4 class="panel-title paramLengow">
            <i class="icon icon-cog icon-2x"></i> <a role="button" data-toggle="collapse" data-parent="#accordion"
...
<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
    <div class="panel panel-default">
        <h4 class="panel-title paramLengow">
            <i class="icon icon-lock icon-2x"></i> <a class="collapsed" role="button" data-toggle="collapse"
...
<div class="panel panel-default">
    <h4 class="panel-title paramLengow">
        <i class="icon icon-external-link icon-2x"></i> <a class="collapsed" role="button" data-toggle="collapse"
    ...
    <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
        <div class="panel-body">
            <form id="_form" class="form-group formLengow"
                ...
                <input type="checkbox" data-size="mini" data-on-text="Yes" data-off-text="No" name="lengow_export_new"
                ...
                <input type="checkbox" data-size="mini" data-on-text="Yes" data-off-text="No" name="lengow_export_file"
                       class="switchLengow" id="active_on"
...
<div class="panel panel-default">
    ...
    //////////////////////////////////////////////////////////////*}
    <h4 class="panel-title paramLengow">
        <i class="icon icon-download icon-2x"></i> <a class="collapsed" role="button" data-toggle="collapse"
    ...
    <div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour">
        <div class="panel-body">
            ...
            <div class="clear"></div>-->
                ...
                <input type="checkbox" data-size="mini" data-on-text="Yes" data-off-text="No" name="lengow_report_mail"
                       class="switchLengow" id="active_on"
...
<div class="panel panel-default">
    <h4 class="panel-title paramLengow">
        <i class="icon icon-repeat icon-2x"></i> <a class="collapsed" role="button" data-toggle="collapse"
...
<div class="panel panel-default">
    <h4 class="panel-title paramLengow">
        <i class="icon icon-cogs icon-2x"></i> <a class="collapsed" role="button" data-toggle="collapse"
