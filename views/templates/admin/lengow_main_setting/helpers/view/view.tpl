...
<div id="lengow_form_wrapper" class="lengow_main_setting" xmlns="http://www.w3.org/1999/html">
    <div class="lengow_main_setting_block">
        <form class="lengow_form" method="POST">
            <input type="hidden" name="action" value="process">
            <div class="container">
                <h2><span>{$locale->t('global_setting.screen.notification_alert_title')|escape:'htmlall':'UTF-8'}</span></h2>
            ...
            <div id="preprod_setting" class="container">
                <h2><span>{$locale->t('global_setting.screen.preprod_mode_title')|escape:'htmlall':'UTF-8'}</span></h2>
                <div class="lengow_main_setting_block_content">
            ...
            <div class="container">
                <h2><span>{$locale->t('global_setting.screen.log_file_title')|escape:'htmlall':'UTF-8'}</span></h2>
                <div class="lengow_main_setting_block_content">
            ...
            <div id="lengow_delete_module" class="container">
                <h2><span>{$locale->t('global_setting.screen.uninstall_module')|escape:'htmlall':'UTF-8'}</span></h2>
                <div class="lengow_main_setting_block_content">
