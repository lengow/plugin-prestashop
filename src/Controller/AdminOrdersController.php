...
/**
 * Lengow Orders List Controller for PrestaShop 9
 */
class AdminOrdersController extends FrameworkBundleAdminController
{
    ...
    public function indexAction(Request $request): Response
    {
        ...
        $currentController = 'LengowOrderController';
        
        // Prepare display data using legacy controller
        $lengowController = new \LengowOrderController();
        $lengowController->prepareDisplay();
        
        return $this->render('@Modules/lengow/views/templates/admin/orders/index.html.twig', [
            'locale' => $locale,
    ...
    /**
     * Handle AJAX actions for orders page
     *
