...
/**
 * Lengow cron (order import / sync) front-office controller.
 *
 * Accessible at: /index.php?fc=module&module=lengow&controller=cron
 * With pretty URLs: /module/lengow/cron
 */
class LengowCronModuleFrontController extends ModuleFrontController
{
    public function initContent(): void
    {
        ...
        if (Tools::getIsset(LengowImport::PARAM_GET_SYNC) && Tools::getValue(LengowImport::PARAM_GET_SYNC) == 1) {
            ...
            $force = Tools::getIsset(LengowImport::PARAM_FORCE)
                ? (bool) Tools::getValue(LengowImport::PARAM_FORCE)
                : false;
