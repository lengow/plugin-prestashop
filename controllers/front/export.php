...
/**
 * Lengow export front-office controller.
 *
 * Accessible at: /index.php?fc=module&module=lengow&controller=export
 * With pretty URLs: /module/lengow/export
 */
class LengowExportModuleFrontController extends ModuleFrontController
{
