    ...
    public function hookAdminOrder($args)
    {
        if (LengowOrder::isFromLengow($args['id_order'])) {
            ...
            if (_PS_VERSION_ < '1.5') {
                ...
                $action_reimport = 'index.php?controller=AdminLengow&id_order='.$lengow_order->id.'&lengoworderid='.$lengow_order->lengow_order_id.'&action=reimportOrder&ajax&token='.Tools::getAdminTokenLite('AdminLengow');
