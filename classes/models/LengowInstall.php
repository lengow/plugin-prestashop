...
class LengowInstall
{
    ...
    private array $oldFiles = [
        ...
        'views/PrestaShop/Admin/Sell/Order/Order/Blocks/View/shipping.html.twig',
        'views/templates/admin/footer.tpl',
        'views/templates/admin/header.tpl',
        'views/templates/admin/header_order.tpl',
        'views/templates/admin/lengow_dashboard/helpers/view/dashboard.tpl',
        'views/templates/admin/lengow_dashboard/helpers/view/status.tpl',
        'views/templates/admin/lengow_dashboard/helpers/view/view.tpl',
        'views/templates/admin/lengow_dashboard/layout.tpl',
        'views/templates/admin/lengow_feed/helpers/view/view.tpl',
        'views/templates/admin/lengow_feed/layout.tpl',
        'views/templates/admin/lengow_help/helpers/view/view.tpl',
        'views/templates/admin/lengow_help/layout.tpl',
        ...
        'views/templates/admin/lengow_home/helpers/view/connection_home.tpl',
        'views/templates/admin/lengow_home/helpers/view/view.tpl',
        'views/templates/admin/lengow_home/layout.tpl',
        'views/templates/admin/lengow_legals/helpers/view/view.tpl',
        'views/templates/admin/lengow_legals/layout.tpl',
        'views/templates/admin/lengow_main_setting/helpers/view/view.tpl',
        'views/templates/admin/lengow_main_setting/layout.tpl',
        ...
        'views/templates/admin/lengow_order/helpers/view/view.tpl',
        'views/templates/admin/lengow_order/helpers/view/warning_message.tpl',
        'views/templates/admin/lengow_order/layout.tpl',
        ...
        'views/templates/admin/lengow_order_setting/helpers/view/marketplace_method.tpl',
        'views/templates/admin/lengow_order_setting/helpers/view/view.tpl',
